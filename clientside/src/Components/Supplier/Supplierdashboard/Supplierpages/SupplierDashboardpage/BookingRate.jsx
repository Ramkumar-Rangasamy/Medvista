  ...
  return (
    <>
      <div className='booking-header'>
        <h2 className="booking-title">Order Rate</h2>
      ...
      <div className="booking-area">
        <div className="rate">
          ...
          <p className='booking-description'>Your highest order rate this week</p>
          <p className="increase">Your order rate is 6% increase from the previous week</p>
        </div>
        <div className="chart">
