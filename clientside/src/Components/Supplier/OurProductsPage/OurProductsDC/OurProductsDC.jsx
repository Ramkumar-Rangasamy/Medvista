...
import './ourproductsdc.css';

import Productslist1 from '../Assets/product-1.jpeg';
import Productslist2 from '../Assets/product-2.jpeg';
import Productslist3 from '../Assets/product-3.jpeg';
import Productslist4 from '../Assets/product-4.jpeg';
...
const OurProductsDC = ({ products }) => {
  ...
  return (
    <div className="OurProductsDC-blogPage-Doctors-container">
      ...
      <div className="OurProductsDC-blogPageDoctorCardBox">
        {products.map((product) => (
          <div key={product._id} className="OurProductsDC-blogPageDoctorCard">
            <div className="OurProductsDC-blogPageDoctorCardImgBox">
              <Link href={`/book-appointment-profile/${product._id}`}>
                <img src={bufferToBase64(product.images[0].data)} alt={product.name} />
              </Link>
              {/* <span className="OurProductsDC-verifiedTick">
                  <VerifiedTick />
                </span> */}
            </div>

            <div className="OurProductsDC-blogPageDoctorCard-content">
              <div className="OurProductsDC-blogPageDoctorCardHeader">
                <h3 className="OurProductsDC-blogPageDoctorCardName">
                  {product.name}
                </h3>
                <div className="OurProductsDC-blogPageDoctorCardRating">
                  <IoIosStar /> {product.rating}
                </div>
              </div>

              <div className="OurProductsDC-blogPageDoctorCardSpecialist">
                <DoctorSymbol /> <p>{product.category}</p>
              </div>
